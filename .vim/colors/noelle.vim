...
"let s:gb.bright_red     = ['#832426', 167]     " 251-73-52
"let s:gb.bright_green   = ['#6F873E', 142]     " 184-187-38
"let s:gb.bright_yellow  = ['#B68806', 214]     " 250-189-47
"let s:gb.bright_blue    = ['#7B91B3', 109]     " 131-165-152
"let s:gb.bright_purple  = ['#C97270', 175]     " 211-134-155
"let s:gb.bright_aqua    = ['#63A098', 108]     " 142-192-124
"let s:gb.bright_orange  = ['#d65d0e', 208]     " 254-128-25

"let s:gb.neutral_red    = ['#873E40', 124]     " 204-36-29
"let s:gb.neutral_green  = ['#839A53', 106]     " 152-151-26
"let s:gb.neutral_yellow = ['#D4A520', 172]     " 215-153-33
"let s:gb.neutral_blue   = ['#A6B6CE', 66]      " 69-133-136
"let s:gb.neutral_purple = ['#D68482', 132]     " 177-98-134
"let s:gb.neutral_aqua   = ['#89BEB7', 72]      " 104-157-106
"let s:gb.neutral_orange = ['#fe8019', 166]     " 214-93-14

"let s:gb.faded_red      = ['#C2585B', 88]      " 157-0-6
"let s:gb.faded_green    = ['#B2C885', 100]     " 121-116-14
"let s:gb.faded_yellow   = ['#DABC65', 136]     " 181-118-20
"let s:gb.faded_blue     = ['#BCC8DA', 24]      " 7-102-120
"let s:gb.faded_purple   = ['#DFA9A8', 96]      " 143-63-113
"let s:gb.faded_aqua     = ['#FF0200', 66]      " 66-123-88
"let s:gb.faded_orange   = ['#E19C63', 130]     " 175-58-3
